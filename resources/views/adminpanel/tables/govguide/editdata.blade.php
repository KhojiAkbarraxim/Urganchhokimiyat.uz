...
<body>
    <div class="container">
        <br>
        <h3>{{ $govguide->id }} - Malumot</h3>
        <br>
        <form id="editForm" action="{{ route('govguide.update', ['govguide' => $govguide->id]) }}" method="POST"
            ...
            <div class="form-group mb-3">
                ...
                <p class="fs-5 d-inline">(oldingi fayl: <span
                        style="color: rgb(13, 57, 168)">{{ $govguide->file_path }}</span>)</p><br>
                @error('file_path')
