                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-cm-12">
                            ...
                            <div class="sidebar">
                                ...
                                <h3 class="sidebar-title">Exit</h3>
                                ...
                                <bytton id="btn-1" class="btn btn-light">Political</bytton>
                                <bytton id="btn-2" class="btn btn-light">Social</bytton>
                                <bytton id="btn-3" class="btn btn-light">Economic</bytton>
                                <bytton id="btn-4" class="btn btn-light">Ecology</bytton>
                                <bytton id="btn-5" class="btn btn-light">Business</bytton>
                                <bytton id="btn-6" class="btn btn-light">Statistics</bytton>
                                <bytton id="btn-7" class="btn btn-light">Health</bytton>
                            </div>
                            <!-- </div> -->
                ...
                for (let i = 0; i < 6; i++) {
                    ...
                    for (let j = 0; j < 7; j++) {
                        if (i === 0 && j < startingDay) {
                            ...
                            calendarHTML +=
                                `<td${(date === currentDate.getDate() && month === currentDate.getMonth() && year === currentDate.getFullYear()) ? ' class="current-month"' : ''}>${date}</td>`;
                            date++;
                        }
                    }
                    calendarHTML += '</tr>';
